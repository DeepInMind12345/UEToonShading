...
private:
	...
	void UpdateViews()
	{
		...
		{
			TArray<TSOAView<TGeometryParticles<T, d>>> TmpArray = { StaticParticles.Get(), KinematicParticles.Get(), DynamicParticles.Get(), {&NonDisabledClusteredArray}, GeometryCollectionParticles.Get() };
